...
do
    ...
    python darknet_find_object_from_video.py -v ../../../dataset/carrots/videos/group_b/carrot_b$i.avi -l $l -od ../../../dataset/carrots/detected_by_gcnn/from_videos/group_b/carrot_b$i -m $m
    sleep 5
done
