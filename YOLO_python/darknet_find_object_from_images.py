...
if __name__ == "__main__":
    ...
    parser = argparse.ArgumentParser(description='yolov2 darknet detection')
    ...
    for f in files:
        ...
        for i in r:
            ...
            cv2.putText(img, i[0].decode() + " [" + str(round(i[1] * 100, 2)) + "%]",
                        (pt1[0]+2, pt1[1]+25), cv2.FONT_HERSHEY_SIMPLEX, 0.8, (0,255,0), 3)
    ...
    print str(im_cnt) + " " + args.label + " images are saved."
