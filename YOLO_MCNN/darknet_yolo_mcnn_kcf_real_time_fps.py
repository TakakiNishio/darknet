...
if __name__ == "__main__":
    ...
    while(1):
        ...
        for i in yolo_predicrion_result:
            ...
            # else:
            #     fps_gcnn.append(fpsWithTick.get())                
        ...
        fps = fpsWithTick.get()
        fps_gcnn_mcnn.append(fps)
        # print("gcnn mcnn fps: " + str(fps))
    ...
    # fps1 = mean(fps_gcnn)
    fps2 = mean(fps_gcnn_mcnn)
    fps3 = mean(fps_kcf)
    # print('gcnn fps: {0:.2f}'.format(fps1))
    print('gcnn mcnn fps: {0:.3f}'.format(fps2))
    print('kcf fps: {0:.3f}'.format(fps3))
