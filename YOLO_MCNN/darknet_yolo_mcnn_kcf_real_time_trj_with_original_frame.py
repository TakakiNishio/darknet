...
if __name__ == "__main__":
    ...
    if not args.save_name == False:
        ...
        rec_original = initWriter(frame_width, frame_height, fps, save_path+'original_'+args.save_name)
    ...
    while(1):
        ...
        if tracking_flag:
            ...
            if track:
                ...
                cv2.circle(img, target_center, 8, (0, 215, 253), -1)
                ...
                for m in range(1, len(trajectory_points)):
                    if trajectory_points[m - 1] is None or trajectory_points[m] is None:
                        continue
                    cv2.line(img, trajectory_points[m-1], trajectory_points[m],
                             (0, 255, 127), thickness = 4)
                ...
                if not args.save_name == False:
                    ...
                    rec_original.write(img_original)
